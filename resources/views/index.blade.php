...
<!-- this is the beginning of service section  -->
    ...
    <section class="liveprice-table">
        ...
        <!-- this is the table that contains the updated prices  -->
           <body>
              <div style="height:560px; background-color: #000000; overflow:hidden; box-sizing: border-box; border-radius: 4px;
